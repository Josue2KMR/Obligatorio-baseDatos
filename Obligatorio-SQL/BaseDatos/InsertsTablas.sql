...
INSERT INTO
    programa_academico (nombre_programa, id_facultad, tipo)
VALUES
...
-- INSERTAR SALAS
INSERT INTO
    sala (nombre_sala, edificio, capacidad, tipo_sala)
VALUES
...
VALUES
    (
        ...
        'Avril',
        'Fernández',
        'avril.fernandez@correo.ucu.uy'
    ),
    (
        43215678,
        'Josue',
        'Pérez',
        'josue.perez@correo.ucu.uy'
    ),
    (
        49876543,
        'Mateo',
        'Castro',
        'mateo.castro@correo.ucu.uy'
    ),
    (
        52345671,
        'Joaquin',
        'Silva',
        'joaquin.silva@correo.ucu.uy'
    ),
    (
        51478932,
        'Guillermo',
        'López',
        'guillermo.lopez@correo.ucu.uy'
    ),
    (
        50987456,
        'Lucía',
        'Rodríguez',
        'lucia.rodriguez@correo.ucu.uy'
    ),
    (
        47654321,
        'Camila',
        'Santos',
        'camila.santos@correo.ucu.uy'
    ),
    (
        48976540,
        'Martín',
        'González',
        'martin.gonzalez@correo.ucu.uy'
    ),
    (
        52789452,
        'Valentina',
        'Suárez',
        'valentina.suarez@correo.ucu.uy'
    ),
    (
        50123498,
        'Sofía',
        'Torres',
        'sofia.torres@correo.ucu.uy'
    );
